...
@RoutePage()
class Paso3Page extends StatefulWidget {
  const Paso3Page({super.key});

  @override
  State<Paso3Page> createState() => _Paso1PageState();
}

class _Paso1PageState extends State<Paso3Page> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Paso 3: Verificación de Titulo Academico"),
      ),
      body: ListView(
        ...
        children: [
          ...
          _buildScanCard(
            title: "Anverso de tu Titulo Academico",
            onScan: () => _scanDocument(true),
            imagePath: _frontImagePath,
            icon: Icons.credit_card_rounded,
          ),
          _buildScanCard(
            title: "Reverso del Titulo Academico",
